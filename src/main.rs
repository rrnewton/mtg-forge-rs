...
async fn main() -> Result<()> {
    ...
    match cli.command {
        ...
        Commands::Tourney {
            ...
            p2,
            seed,
        } => run_tourney(decks, games, seconds, p1, p2, seed).await?,
        Commands::Resume {
            snapshot_file,
            override_p1,
            override_p2,
...
async fn run_tourney(
    ...
    // Resolve master seed if provided
    let seed_resolved = seed.map(|s| s.resolve());
    ...
    struct Stats {
        ...
        p2_wins: usize,
        draws: usize,
        deck_wins: std::collections::HashMap<String, usize>,
        deck_games: std::collections::HashMap<String, usize>,
        matchup_results: std::collections::HashMap<(String, String), (usize, usize, usize)>, // (p1_wins, p2_wins, draws)
    }
    ...
    (0..total_games).into_par_iter().for_each(|game_idx| {
        ...
        let game_result = tokio::runtime::Runtime::new()
            ...
            .block_on(async {
                ...
                Ok::<_, mtg_forge_rs::MtgError>((result.winner, p1_id, p2_id))
            });
