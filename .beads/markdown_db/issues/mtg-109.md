...
**Current Status**: Reverted attempted fix, documented issue for future work
- Heuristic vs Heuristic tests: PASSING (deterministic, no affected by this issue)
- Random vs Heuristic tests: Shows non-determinism, but also has logging mismatches
- The logging mismatches are a SYMPTOM of this architectural issue, not the root cause
