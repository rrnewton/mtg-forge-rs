...
- `src/game/game_loop.rs` - Added `with_choice_counter()`, fixed replay mode logic
- `src/main.rs` - Fixed baseline setup in `run_tui()` and `run_resume()`

### Conclusion

✅ **Full determinism restored**
✅ **GameStates match perfectly**
✅ **Choice counter persistence working**
✅ **Replay mode suppression working**
✅ **Stress tests passing (modulo minor cosmetic issue)**

**mtg-109 can now be CLOSED** - all core objectives achieved!
